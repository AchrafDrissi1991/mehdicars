...
export const mediaItems: MediaItem[] = [
  {
    id: 'video-1',
    title: {
      fr: 'Inspection complète d\'un véhicule',
      de: 'Umfassende Fahrzeuginspection',
      en: 'Complete vehicle inspection',
      es: 'Inspección completa de un vehículo',
    },
    description: {
      fr: 'Découvrez notre processus complet d\'inspection',
      de: 'Entdecken Sie unseren umfassenden Inspektionsprozess',
      en: 'Discover our complete inspection process',
      es: 'Descubra nuestro proceso completo de inspección',
    },
    youtubeId: '_My65ts9MA0',
    duration: '5:32',
    category: { fr: 'Inspection', de: 'Inspektion', en: 'Inspection', es: 'Inspección' },
  },
  {
    id: 'video-2',
    title: {
      fr: 'Guide d\'achat automobiles en Allemagne',
      de: 'Leitfaden zum Autokauf in Deutschland',
      en: 'Guide to buying cars in Germany',
      es: 'Guía para comprar coches en Alemania',
    },
    description: {
      fr: 'Conseils pratiques pour l\'achat en Allemagne',
      de: 'Praktische Tipps zum Kaufen in Deutschland',
      en: 'Practical tips for buying in Germany',
      es: 'Consejos prácticos para comprar en Alemania',
    },
    youtubeId: 'qglmGWu16Rk',
    duration: '8:15',
    category: { fr: 'Guide', de: 'Anleitung', en: 'Guide', es: 'Guía' },
  },
  {
    id: 'video-3',
    title: {
    ...
    description: {
      fr: 'Écoutez nos clients satisfaits',
      de: 'Hören Sie von unseren zufriedenen Kunden',
      en: 'Hear from our satisfied customers',
      es: 'Escuche a nuestros clientes satisfechos',
    },
    youtubeId: 'wTpZaLVz2yk',
    duration: '6:48',
    category: { fr: 'Témoignage', de: 'Bewertung', en: 'Testimonial', es: 'Testimonio' },
  },
  {
    id: 'video-4',
    title: {
